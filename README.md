...
| role_nutanix_prism_proxy_host_validate_certs | no       | false    | true / false                                                                    | Whether to check if Prism UI certificates are valid.                                                                                               |
| role_nutanix_prism_proxy_debug               | no       | false    | true / false                                                                    | Enable debug logging.                                                                                                                              |
